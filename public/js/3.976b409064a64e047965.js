...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    deletePost: function deletePost(id) {
      axios__WEBPACK_IMPORTED_MODULE_2___default.a["delete"]("/posts/".concat(id, "/delete")).then(function () {})["catch"](function (_ref) {
  ...
  return _c("layout", [
    _c(
      ...
      [
        ...
        _vm._v(" - "),
        _c("a", { attrs: { href: "/posts/create" } }, [_vm._v("Create Post")]),
        _vm._v(" "),
