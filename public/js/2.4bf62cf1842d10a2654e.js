...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'axio'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    logout: function logout() {
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'axio'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).post('/logout').then(function (_ref) {
        var response = _ref.response;
